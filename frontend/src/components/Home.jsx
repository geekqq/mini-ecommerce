  ...
  return (
    <div className='w-full mx-auto'>
        <div className='text-center font-raleway w-full max-w-5xl mx-auto my-6'>
            ...
            <div className='flex flex-col lg:flex-row justify-center items-center mx-auto w-full 
                my-16 border-2 bg-[#fcf6f6] border-slate-100 shadow-md py-4'>
                ...
                <div className='flex flex-col lg:w-6/12 w-full py-8'>
                    ...
                    <div className='flex text-slate-900 justify-center items-center mb-10'>
                        <span onClick={decrement} className='select-none w-auto px-4  py-1 text-5xl bg-red-100 cursor-pointer'>-</span>
                    ...
                    <div className='my-6'>
                        <button onClick={checkout} className='bg-green-400 text-white px-8 py-4 rounded-md text-2xl font-semi'>Checkout</button>
                    </div>
                </div>
            </div>
        </div>
